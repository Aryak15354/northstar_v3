...
- [ ] 4.1 Write property test for single market state file
...
- [ ] 5.1 Write property test for exposure minimum selection
...
- [ ] 6.1 Write property test for state manager read-only behavior
...
- [ ] 7.1 Write property test for exposure history append
  - **Property 6: Exposure History Append**
  - **Validates: Requirements 7.1, 7.2**
