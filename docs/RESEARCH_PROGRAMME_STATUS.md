...
| **Universe tiers (G8-07/G8-11)** | non-F&O lead is **~86% a date artifact** (+0.299 → +0.042 net of cost on a common index). G8-11's "correction" is worse — 41.8% of its winning tier's sample is **synthetic zeros**. Mechanism relocates to a continuous size/ADV gradient. G9-01 unaffected, verified. |
