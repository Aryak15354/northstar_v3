...
def test_reconciler_initialization():
    ...
    # Initialize bridges
    shadow_bridge = ShadowStateBridge(shadow_state_path="data/portfolio/shadow_portfolio_state.parquet", state_authority=state_authority)
    valuation_bridge = ValuationStateBridge(state_authority)
    runtime_bridge = RuntimeStateBridge(db_path="data/runtime/portfolio_runtime.db", json_path="data/portfolio/current_positions.json", state_authority=state_authority)
