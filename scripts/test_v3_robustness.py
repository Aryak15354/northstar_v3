        ...
        for file_path in critical_files:
            if os.path.exists(file_path):
                ...
                try:
                    ...
                    # ANY response without crashing means the system handled corruption correctly
                    # Warnings are EXPECTED and show proper error handling
                    corruption_handled = (
                        result is not None and 
                        isinstance(result, dict)  # Any dict response = graceful handling
                    )
