...
def main():
    ...
    try:
        ...
        # Execute directly to avoid queue-timeout when controller background loop is not started.
        result = controller.execute_alpha_validation(parameters=parameters)
