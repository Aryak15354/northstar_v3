...
class SystemStatusChecker:
    ...
    def check_system_components(self):
        ...
        components = {
            ...
            'Risk Authority': 'src/volatility/risk_authority.py',
            'Portfolio Coordinator': 'src/portfolio/unified_portfolio_coordinator.py',
            'Intelligence Engine': 'src/volatility/intelligence_engine.py',
    ...
    def generate_recommendations(self):
        ...
        if missing_critical:
            recommendations.append({
                ...
                'action': "Run: python3 scripts/run_complete_v3_system.py --data-only"
            })
...
def main():
    ...
    if system_healthy:
        ...
        print("     python3 launch_dashboard.py             # Launch canonical dashboard")
        print("     python3 scripts/run_complete_v3_system.py  # Full canonical pipeline")
        print("     python3 run.py --mode update            # Canonical update mode")
    else:
