...
try:
    ...
    from intelligence.confidence_engine import ConfidenceWeightedSignalProcessor
    from intelligence.bayesian_engine import BayesianSignalFusion, ContradictionResolver
    from intelligence.narrative_engine import NarrativeEngine
    from intelligence.memory_engine import MemoryEngine, LearningCoordinator
except ImportError:
...
class IntelligenceStack:
    ...
    def resolve_contradictions(self, intelligence_result):
        ...
        try:
            ...
            import sys
            import os
            sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(__file__)), 'cohesion'))
    ...
    def run_intelligence_update(self, ticker=None):
        ...
        # Load market data
        try:
            from state.market_state import load_latest_market_state
