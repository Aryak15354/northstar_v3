...
from src.intelligence.adv_database import ADVConfig, ADVDatabase, LiquidityTier
from src.intelligence.position_governor import PositionGovernor, GovernorConfig

# Import existing institutional components
if TYPE_CHECKING:
    from src.intelligence.position_inertia_system import PositionInertiaSystem
    from src.intelligence.regime_locked_capital_allocator import RegimeLockedCapitalAllocator
    from src.intelligence.signal_quality_gate import SignalQualityGate
    from src.intelligence.crisis_conviction_contract import RegimeState
