...
### Acceptance Criteria
- [x] Position values never exceed α × ADV limits
- [x] Positions rejected when ADV < $1M daily
- [x] Different α factors applied by asset class (3% equity, 1% small-cap, 5% large-cap)
- [x] Rolling 21-day ADV updates automatically
- [x] Integration tests pass with existing institutional components
...
### Acceptance Criteria
- [x] Impact increases monotonically with order size
- [x] Orders >10% ADV receive enhanced impact penalty
- [x] k-factor adjusts based on market conditions
- [x] Fill prices reflect realistic execution costs
- [x] Cumulative impact tracking across multiple orders
...
### Acceptance Criteria
- [x] Correlation >0.7 triggers 50% capital reduction
- [x] Multiple crowded factors apply multiplicative penalties
- [x] Rolling 63-day correlation updates automatically
- [x] Whitelist exempts differentiated signals
- [x] Factor exposure reports generated
...
### Acceptance Criteria
- [x] AUM sweep tests $10M to $1B systematically
- [x] CAGR degradation measured vs baseline
- [x] Capacity knee identified (>20% performance drop)
- [x] Capacity curves generated and exported
- [x] Stress-adjusted capacity recommendations provided
...
### Acceptance Criteria
- [x] ADV queried for all positions before construction
- [x] Capital redistributed when liquidity insufficient
- [x] 20% minimum cash buffer maintained
- [x] 50% position reduction during market stress
- [x] Positions <$1M ADV rejected automatically
...
### Acceptance Criteria
- [x] Daily ADV updates using rolling windows
- [x] ADV drops >30% trigger position reduction
- [x] Liquidity tier classification updates automatically
- [x] Position limits adjust with tier changes
- [x] Liquidity alerts generated for limit violations
...
### Acceptance Criteria
- [x] 50% ADV reduction stress test implemented
- [x] Historical crisis period testing (2008, 2020, 2022)
- [x] Maximum executable AUM measured under stress
- [x] 95th percentile stress scenario validation
- [x] Stress-adjusted capacity recommendations generated
...
### Acceptance Criteria
- [x] Orders >5% ADV split across multiple days
- [x] TWAP execution simulation implemented
- [x] Bid-ask spreads modeled by liquidity tier
- [x] 2x spread multiplier during market stress
- [x] Implementation shortfall tracking vs theoretical
...
### Acceptance Criteria
- [x] All capacity components integrated into walk-forward engine
- [x] Capacity-constrained validation runs successfully
- [x] Performance comparison (constrained vs unconstrained) generated
- [x] Integration with existing institutional components maintained
- [x] End-to-end system validation passes
...
### Acceptance Criteria
- [x] Systematic capacity sweep completed across $10M-$1B
- [x] Capacity knee identified and documented
- [x] Maximum recommended AUM determined
- [x] Institutional capacity report generated
- [x] Capacity monitoring integrated into dashboard
...
### Technical Success
- [x] All capacity components implemented and tested
- [x] Integration with existing institutional transformation maintained
- [x] Property tests pass for all capacity constraints
- [x] End-to-end capacity analysis completes successfully

### Business Success
- [x] NorthStar's maximum AUM capacity identified
- [x] Capacity limits validated under stress conditions
- [x] Institutional-grade capacity reports generated
- [x] System ready for capital deployment with known limits

### Institutional Readiness
- [x] Capital realism enforced through ADV constraints
- [x] Market impact costs realistically modeled
- [x] Crowding penalties prevent factor overlap
- [x] Capacity analysis provides fund-ready AUM guidance
